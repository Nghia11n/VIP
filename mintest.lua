...
Notify("Mẹo:", "Subcribe Kênh Phong Roblox Sẽ Nhặt Được Kitsune", 5)
...
ImageButton.Image = "http://www.roblox.com/asset/?id=18830041179"
...
local Tabs = {
    Main = Window:AddTab({ Title = "Cày", Icon = "" }),
    Qs = Window:AddTab({ Title = "Boss", Icon = "" }), 
    stack = Window:AddTab({ Title = "Nhiệm Vụ", Icon = "" }), 
    Settings = Window:AddTab({ Title = "Cài Đặt", Icon = "" }),
    St = Window:AddTab({ Title = "Máy Chủ", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Dịch Chuyển", Icon = "" }),   
    RC = Window:AddTab({ Title = "Tộc V4", Icon = "" }),
    Se = Window:AddTab({ Title = "Mirage Island", Icon = "" }),
...
Tabs.Main:AddSection("Hãy Sub Kênh Phong Roblox")
Tabs.Ms:AddButton({
    Title = "Fix Lag",
    Description = "",
    Callback = function()
...
spawn(function()
    ...
    local DropdownTweenSpeed = Tabs.Settings:AddDropdown("DropdownTweenSpeed", {
    Title = "Tốc Độ",
...
DropdownTweenSpeed:OnChanged(function(Value)
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Tự Động Đánh Soul Reaper", Default = false })
...
Tabs.Main:AddSection("Cày Katakuri")
    ...
    spawn(function()
        ...
        Tabs.stack:AddSection("Sea")
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Đánh Nhà Máy", Default = false })
    ...
    Toggle:OnChanged(function(Value)
        ...
        local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Đánh Hải Tặc", Default = false })
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Dừng Khi Có Key Hoặc Cup", Default = true})
...
spawn(function()
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Nhặt Rương Bay", Default = false})
...
spawn(function()
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh Râu Đen", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Cày Vật Chất Kì Dì", Default = false })
	...
	local Dropdown = Tabs.Qs:AddDropdown("Dropdown", {
        Title = "Chọn Boss",
        Values = tableBoss,
        Multi = false,
        Default = 1,
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh Boss", Default = false })
...
spawn(function()
    ...
    Tabs.stack:AddSection("Vật Phẩm")
